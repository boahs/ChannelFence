...
- [ ] Add a monitored support email to `PRIVACY.md` and `ui/privacy.html`.
- [ ] Host the final privacy policy on a public HTTPS URL.
- [ ] Add the public privacy-policy URL in the Developer Dashboard.
...
4. Block again and test Search, Watch Next, Shorts, playlists, and comments.
